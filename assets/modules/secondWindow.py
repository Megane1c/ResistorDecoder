...
class SubWindow2(tk.Toplevel):
    ...
    ##### POSITION OF GUI #####
        ...
        self.resizable(0,0)
        self.title("4-Band-Resistor Value Finder")
        self.iconbitmap(default='assets/img/resistor-512.ico')
        
        self.current_colors = ["brown","green","red","purple4"] # DEFAULT VALUE
        
        self.create_elements()
        
    ##### CLOSING COMMAND #####    
        self.protocol('WM_DELETE_WINDOW',master.close2)
        
    ##### CREATION OF RESISTOR #####     
    def create_elements(self):
        self.resistor = tk.Canvas(self, width=315, height=100)
        ...
        self.band3.create_rectangle((0,0,16,50),fill="black", outline="black")
        self.band3.create_rectangle((17,0,33,50),fill="brown", outline="brown")        
        self.band3.create_rectangle((34,0,51,50),fill="red", outline="red")
        self.band3.create_rectangle((52,0,68,50),fill="orange", outline="orange")
        self.band3.create_rectangle((69,0,85,50),fill="yellow", outline="yellow")
        self.band3.create_rectangle((86,0,103,50),fill="green", outline="green")        
        self.band3.create_rectangle((104,0,118,50),fill="royal blue", outline="royal blue")
        self.band3.create_rectangle((119,0,134,50),fill="purple4", outline="purple4")        
        self.band3.create_rectangle((135,0,150,50),fill="gray", outline="gray")
        self.band3.create_rectangle((151,0,167,50),fill="white", outline="white")
        self.band3.create_rectangle((168,0,184,50),fill="gold", outline="gold")
        self.band3.create_rectangle((185,0,211,50),fill="#C0C0C0", outline="#C0C0C0")
        self.band3.grid(row=3,column=1, columnspan = 2)
        self.band3.bind("<Button 1>", self.b3)

        
        tk.Label(self, text = "Fourth band:\nTolerance").grid(row=4, column=0)
        self.band4 = tk.Canvas(self, width=200, height=50)
        self.band4.create_rectangle((0,0,30,50),fill="brown", outline="brown")
        self.band4.create_rectangle((25,0,60,50),fill="red", outline="red")
        self.band4.create_rectangle((50,0,90,50),fill="green", outline="green")
        self.band4.create_rectangle((75,0,120,50),fill="royal blue", outline="royal blue")
        self.band4.create_rectangle((100,0,150,50),fill="purple4", outline="purple4")
        self.band4.create_rectangle((125,0,180,50),fill="gray", outline="gray")
        self.band4.create_rectangle((150,0,210,50),fill="gold", outline="gold")
        self.band4.create_rectangle((175,0,240,50),fill="#C0C0C0", outline="#C0C0C0")      
        self.band4.grid(row=4,column=1, columnspan = 2)
        self.band4.bind("<Button 1>", self.b4) 

        self.result = tk.Text(self, width=35, height=1)
        self.result.grid(row=5,column=0, columnspan=3)

        self.min= tk.Text(self, width=35, height=1)
        self.min.grid(row=6,column=0,columnspan=3,padx=10, pady=10)
        
        self.max= tk.Text(self, width=35, height=1)
        self.max.grid(row=7,column=0,columnspan=3,padx=5, pady=5)  
    ...
    def b3(self, event):
        if event.x <= 17:
            ...
            self.change(3,"orange")
        elif event.x <=86:
            self.change(3,"yellow")
        elif event.x <=104:
            self.change(3,"green")
        elif event.x <=119:
            self.change(3,"royal blue") 
        elif event.x <=135:
            self.change(3,"purple4")
        elif event.x <=151:
            self.change(3,"gray")
        elif event.x <=168:
            self.change(3,"white")
    ...
    def calculate(self):
        ...
        ans = float(val)
        band3 = str(self.current_colors[2])
        if band3 == "black":
            rslt = ans*1
            return round(rslt,5)
        elif band3 == "brown":
    ...
    def ch(self):
        band = str(self.current_colors[3])
        if band == 'brown':
            return '1'
        elif band == 'red':
            return '2'
    ...
    def Min(self):
        ans = (self.calculate()) - ((self.calculate())*(float(self.ch())/100))
        return round(ans,5)
